...
| 13 | main-stack-agents-flow | B | **A** | 1 | SATISFIED | none (added negative scope + companion routing to description) |
...
| 47 | project-quality-loop | B | **A** | 1 | SATISFIED | none (routed flat-fan-out policy to cross-stack-agents-flow) |
...
| 50 | cross-stack-agents-flow | B | **A** | 1 | SATISFIED | none (model-routing 'pins ARE defaults' contradiction; 'licence'->'license') |

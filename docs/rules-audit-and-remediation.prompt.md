...
- No conflicts. The file does not contradict another loaded file, another tier, or an existing hook or permissions entry. Scored against the conflict map. (8)

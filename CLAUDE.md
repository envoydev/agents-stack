...
- `claude/` - the **Claude Code** stack:
  ...
  - `rules/` - twenty rules, fetched into a project's `.claude/rules/`, each doing ONE job. Ten
    ...
    security, git + pre-commit, navigation, agents-skills, mcp-tools - loaded every session and

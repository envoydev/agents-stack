...
## Execution modes
DELEGATED vs INLINE - and why detection keys on dispatch capability, not file presence - is the shared policy `cross-stack-agents-flow` owns. Pick the mode once, before DESIGN, hold it for the run, and apply it to this vertical:

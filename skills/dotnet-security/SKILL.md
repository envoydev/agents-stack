...
- **Pin and verify.** Lock files plus package-source mapping (`AddPackageSourceMapping`) stop a dependency-confusion swap, where a malicious public package shadows an internal one.

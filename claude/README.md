...
| --------- | ----- | ----- |
| **Skills**  | 76 | conventions + utilities (ticket writers, C#/.NET, Angular/TS, SQL, Docker, git, `domain-build` per-domain orchestration) - `npx skills add … --agent claude-code` |

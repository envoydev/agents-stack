...
| --------- | ----- | ----- |
| **Skills**  | 57 | conventions + utilities (ticket writers, C#/.NET, Angular/TS, SQL, `main-stack-agents-flow` per-domain orchestration + `cross-stack-agents-flow` cross-domain routing) - `npx skills add … --agent claude-code` |

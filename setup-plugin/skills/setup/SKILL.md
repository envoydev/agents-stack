...
## 4. Fetch the tools
Into the temp dir, download the right installer (`scripts/claude-stack.sh` or `scripts/claude-stack.ps1`), plus `scripts/stack-select.js`, `scripts/stack-graph.json`, and `templates/CLAUDE.template.md` (for step 9).
